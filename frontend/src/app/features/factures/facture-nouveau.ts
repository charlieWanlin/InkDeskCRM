...
import { LigneFacture, toInvoiceJson } from './models/facture.model';
...
@Component({
  selector: 'app-facture-nouveau',
  imports: [ReactiveFormsModule, RouterLink, Button, Icon, StudioLetterhead],
  templateUrl: './facture-nouveau.html',
})
export class FactureNouveau {
  ...
  private nouvelleLigne(l?: Partial<LigneFacture>): LigneForm {
  ...
  creer() {
    ...
    const lignesValides: LigneFacture[] = v.lignes
